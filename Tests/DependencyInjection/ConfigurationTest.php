...
namespace Jul6Art\ApiBundle\Tests\DependencyInjection;

use Jul6Art\ApiBundle\DependencyInjection\Configuration;
...
final class ConfigurationTest extends TestCase
{
    ...
    {
        self::assertSame('api', new Configuration()->getConfigTreeBuilder()->buildTree()->getName());
    }
