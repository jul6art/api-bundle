...
use Jul6Art\ApiBundle\ApiBundle;
...
{
    /**
     * @param array<string, mixed> $bundleConfig configuration for the "api" extension
    ...
    {
        return \sprintf('%s/jul6art-api-bundle-tests/%s/%s', sys_get_temp_dir(), $this->uniqueId, $this->environment);
    }

    private function configure(ContainerBuilder $container): void
    {
        $container->loadFromExtension('framework', [
            'secret' => 'jul6art-api-bundle-tests',
        ...
        $container->loadFromExtension('api', $this->bundleConfig);
    }
            ...
            'orm' => [
                ...
                'mappings' => [
                    'ApiBundleTests' => [
                        'type' => 'attribute',
                        'dir' => __DIR__.'/Entity',
                        'prefix' => 'Jul6Art\ApiBundle\\Tests\\Fixtures\\Entity',
                        'is_bundle' => false,
                    ],
                ],
            ],
